                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input  name="password" required id="password" type="password"  class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input  name="verifypassword" required type="password" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>					
