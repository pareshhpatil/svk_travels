        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <form action="/admin/logsheet/savelogsheet" method="post" >
                    ...
                    <div class="col-md-6">
                         Bill Date :<input type="text" name="bill_date" style="max-width: 200px;" readonly="" required="" value="{{$invoice.bill_date}|date_format:"%d-%b-%Y"}" autocomplete="off" class="form-control form-control-inline date-picker" data-date-format="M yyyy" >
                        <br>
