...
/**
 * This is a base class for all object types within Siddhivinayak application.
 * This call instantiates the log object and other bootstrapping objects required for Siddhivinayak application.
 *
 * @author Shuhaid
 */
class SwipezLogger {
